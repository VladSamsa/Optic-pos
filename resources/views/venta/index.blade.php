                                ...
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    @can('eliminar-venta')
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#confirmModal-{{$item->id}}">Eliminar
                                        </button>
                                    @endcan
                                    <button type="button" class="btn btn-warning complete-status"
                                            data-id="{{ $item->id }}">Entregar
                                    </button>
                                </div>
                            </td>
                        </tr>
...
@push('js')
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', event => {
            ...
            // Event listener for the "Entregar" button
            document.querySelectorAll('.complete-status').forEach(button => {
                button.addEventListener('click', function () {
                    var ventaId = this.getAttribute('data-id');

                    fetch('/ventas/complete_status', {
                        method: 'POST',
                        headers: {
